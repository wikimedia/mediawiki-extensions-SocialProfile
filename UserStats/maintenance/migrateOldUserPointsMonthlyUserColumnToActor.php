 ...
 * @since January 2020
 */
class MigrateOldUserPointsMonthlyUserColumnToActor extends LoggedUpdateMaintenance {
	public function __construct() {
		parent::__construct();
		$this->addDescription( 'Migrates data from old _user_name/_user_id columns in the user_points_monthly table to the new actor column.' );
	}
...
$maintClass = MigrateOldUserPointsMonthlyUserColumnToActor::class;
