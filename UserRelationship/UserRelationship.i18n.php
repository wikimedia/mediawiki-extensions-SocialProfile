...
אתם תקבלו הודעה כש־$1 יאשר את בקשתכם.',
	'ur-add-error-message-not-loggedin' => 'עליכם להיות מחוברים כדי להוסיף $1',
	'ur-add-error-message-not-loggedin-foe' => 'עליכם להיות מחוברים כדי להוסיף יריב',
	'ur-add-error-message-not-loggedin-friend' => 'עליכם להיות מחוברים כדי להוסיף חבר',
	'ur-requests-title' => 'בקשות חברות',
	'ur-requests-message-foe' => '<a href="$1">$2</a> מעוניין להיות יריבכם.',
	'ur-requests-message-friend' => '<a href="$1">$2</a> מעוניין להיות חברכם.',
	'ur-accept' => 'אישור',
	'ur-reject' => 'סירוב',
	'ur-no-requests-message' => 'אין לכם בקשות חברות או יריבות.
אם ברצונך בחברים נוספים, <a href="$1">הזמינו אותם!</a>',
	...
	'friend_request_subject' => '$1 הוסיף אתכם כחבר ב{{SITENAME}}!',
	'friend_request_body' => 'שלום רב $1:

$2 הוסיף אתכם כחבר באתר {{SITENAME}}.  רצינו רק לוודא ששניכם אכן חברים.
...
מעוניינים להפסיק לקבל מאיתנו הודעות דוא"ל?

לחצו $4
ושנו את ההגדרות שלכם לביטול התרעות בדוא"ל.',
	'foe_request_subject' => 'זוהי מלחמה! $1 הוסיף אתכם כיריבו באתר {{SITENAME}}!',
	'foe_request_body' => 'שלום רב $1:

$2 הוסיף אתכם כיריב באתר {{SITENAME}}.  רצינו רק לוודא ששניכם אכן יריבים עד המוות או לפחות נושאים מחלוקות.
...
לחצו $4
ושנו את ההגדרות שלכם לביטול התרעות בדוא"ל.',
	'friend_accept_subject' => '$1 קיבל את בקשת החברות שלכם באתר {{SITENAME}}!',
	'friend_accept_body' => 'שלום רב $1:

$2 קיבל את בקשת החברות שלכם באתר {{SITENAME}}!
...
לחצו $4
ושנו את ההגדרות שלכם לביטול התרעות בדוא"ל.',
	'foe_accept_subject' => 'המלחמה החלה! $1 קיבל את בקשת היריבות שלכם באתר {{SITENAME}}!',
	'foe_accept_body' => 'שלום רב $1:

$2 קיבל את בקשת היריבות שלכם באתר {{SITENAME}}!
...
לחצו $4
ושנו את ההגדרות שלכם לביטול התרעות בדוא"ל.',
	'friend_removed_subject' => 'אבוי! $1 הסיר אתכם כחברו באתר {{SITENAME}}!',
	'friend_removed_body' => 'שלום רב $1:

$2 הסיר את החברות ביניכם באתר {{SITENAME}}!
...
לחצו $4
ושנו את ההגדרות שלכם לביטול התרעות בדוא"ל.',
	'foe_removed_subject' => 'ישששש! $1 הסיר אתכם כיריבו באתר {{SITENAME}}!',
	'foe_removed_body' => 'שלום רב $1:

$2 הסיר אתכם כיריבו באתר {{SITENAME}}!

יתכן כי שניכם בדרך להפוך לחברים?
