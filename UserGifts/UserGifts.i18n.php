...
Это также удалит его у всех участников, которым он был передан.',
	'g-description-title' => '$1 подарок «$2»',
	'g-error-do-not-own' => 'Вы не владеете этим подарком.',
	'g-error-message-blocked' => 'Вы сейчас заблокированы и не можете дать подарки',
	'g-error-message-invalid-link' => 'Введённая вами ссылка неверная.',
	'g-error-message-login' => 'Вы должны представиться системе, чтобы отдавать подарки',
	'g-error-message-no-user' => 'Участник, которого вы хотите просмотреть, не существует',
	'g-error-message-to-yourself' => 'Вы не можете передавать подарки себе.',
	'g-error-title' => 'Woops, вы ввели неправильное название!',
	'g-file-instructions' => 'Ваше изображение должно быть в формате jpeg, png или gif (не анимированный gif), и быть меньше 100 КБ размером.',
	'g-from' => 'от <a href="$1">$2</a>',
	'g-gift' => 'подарок',
	'g-gift-name' => 'название подарка',
	'g-give-gift' => 'Передать подарок',
...
Это просто.',
	...
	'g-give-all-title' => 'Передать подарков к $1',
	'g-give-enter-friend-title' => 'Если вы знаете имя участника, введите его ниже',
	'g-given' => 'Этот подарок был передан $1 {{PLURAL:$1|временя|времени|времён}} назад',
	'g-give-list-friends-title' => 'Выбрать из вашего списка друзей',
	'g-give-list-select' => 'выбрать друга',
	'g-give-separator' => 'или',
	'g-give-no-user-message' => 'Подарки и награды являются хорошим путём отметить ваших друзей!',
	'g-give-no-user-title' => 'Кому вы хотели передать подарок?',
	'g-give-to-user-title' => 'Отправить подарок «$1» к $2',
	'g-give-to-user-message' => 'Хотите передать $1 <a href="$2">другой подарок</a>?',
	'g-go-back' => 'Назад',
	...
	'g-recent-recipients' => 'Другие последние получатели этого подарка',
	...
	'g-small' => 'Маленький',
	'g-to-another' => 'Дать кому-нибудь ещё',
	'g-uploadsuccess' => 'Загрузка успешно завершена',
	'g-viewgiftlist' => 'Просмотре списка подарков',
...
Нажмите $5
и измените ваши настройки на отключение уведомлений по электронной почте.',
