...
function createThumbnail($imageSrc, $ext, $imgDest, $thumbWidth){
	...
	<td style='color:#666666;font-weight:800'>".wfMsg('ga-file-instructions')."<p>".wfMsg('ga-choosefile')."<br />
	...
	*/
	function detectScript($file, $mime) {
		...
		wfDebug("SpecialSystemGiftManagerLogo::detectScript: checking for embedded scripts and HTML stuff\n");
